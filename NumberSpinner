do
	local imports = {
	["{E3A978C0-9BA9-41D6-8743-D4FA91FB308D}"] = function()local TextService = game:GetService('TextService')
...
return Digit end,
	["{425C9972-514C-46BA-9852-A28840D704CF}"] = function()local TweenService = game:GetService('TweenService')

local DigitModule = require("{E3A978C0-9BA9-41D6-8743-D4FA91FB308D}")
...
getgenv().Spinner = require("{425C9972-514C-46BA-9852-A28840D704CF}")
